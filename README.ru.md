...
| `click` | Кликнуть элемент (CSS, `@e` реф, семантический). Поддерживает DOM-клик (default) или физический CDP-клик |
...
| `get_text` | Извлечь чистый текст, исходный HTML или структурированные данные страницы |
...
- **Антивирусный анализ (VirusTotal):** Исходный код и сборки расширения проверены на отсутствие вредоносного ПО. [Отчет об анализе (0/70 чистый)](https://www.virustotal.com/gui/file/0df903347798d335ab622f8cb27c13c38a086e1d2f5936c8d099840f76b82802?nocache=1)
- **Политика безопасности:** Подробнее о модели угроз, привязке к localhost и проверке Origin читайте в нашем [SECURITY.md](SECURITY.md).
